...
ArrayList < AllowanceInfo > array = new ArrayList<>();
AllowanceInfo mon = new AllowanceInfo ();
...
System.out.println (" ( 1 ) Enter Allowance for the Month ");
System.out.println (" ( 2 ) Enter Expenses for the Month ");
...
case 1 :
System.out.println ("Enter Allowance for the Month ");
mon.setAllowance();
